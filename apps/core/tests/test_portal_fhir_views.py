    ...
    [
        (
            "patient_dashboard",
            {
                ...
                "latest_vitals_bp_status",
                "latest_vitals_heart_rate_status",
                "latest_vitals_temperature_status",
                "latest_vitals_weight_status",
                "latest_vitals_bp_trend",
                "latest_vitals_heart_rate_trend",
                "latest_vitals_temperature_trend",
                "latest_vitals_weight_trend",
            },
        ),
        (
            "lab_tests",
