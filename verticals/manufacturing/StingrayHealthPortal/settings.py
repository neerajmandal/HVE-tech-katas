"""
Django settings for StingrayHealthPortal project.
...
ROOT_URLCONF = "StingrayHealthPortal.urls"
...
TEMPLATES = [
    {
        ...
        "OPTIONS": {
            "context_processors": [
                ...
                "apps.core.context_processors.domain",
            ],
        },
    },
]

WSGI_APPLICATION = "StingrayHealthPortal.wsgi.application"
